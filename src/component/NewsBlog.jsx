  ...
  return (
    <section className="mx-36">
      ...
      <div className="relative rounded-3xl overflow-hidden">
        ...
        <div
          className="h-56 md:h-64 w-full bg-center bg-cover relative"
          style={{
            backgroundImage:
        ...
        >
          ...
          <div className="relative z-10 h-full flex items-center justify-center">
            <div className="text-center text-white">
              <p className="uppercase tracking-widest text-sm md:text-base/none opacity-90">
                Get Newsletter
              </p>
        ...
        {/* Floating panel */}
        <div className="-mt-10 md:-mt-12 px-4 md:px-8 pb-6">
          <div className="mx-auto max-w-5xl rounded-3xl border border-black/5 bg-white/80 backdrop-blur shadow-md p-6 md:p-8
            ...
            <form
              ...
              className="mx-auto max-w-3xl flex items-stretch gap-3"
            >
              <input
                type="email"
                required
      ...
      <div className="mt-14 md:mt-20">
        ...
        <div className="flex items-start justify-between gap-4 px-2 md:px-0">
          ...
          <a
            href="#"
            className="hidden md:inline-flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-pink-600"
          >
          ...
          {posts.map((p) => (
            ...
            >
              ...
              <div className="relative">
                ...
                />
                <div className="absolute left-4 top-4 rounded-xl bg-pink-600 text-white px-2 py-1 text-center leading-tight shadow">
                  <div className="text-base font-bold">{p.day}</div>
              ...
              <div className="p-5">
                ...
                {/* title */}
                <h4 className="mt-2 font-semibold text-lg hover:text-pink-600 cursor-pointer">
                  {p.title}
                </h4>
